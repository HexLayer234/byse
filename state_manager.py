...
class StateManager:
    """Менеджер глобального состояния бота (потокобезопасный)"""
    ...
    def save_state(self):
        """Сохраняет текущее состояние (вызывать внутри _lock!)"""
        try:
            data = {
    ...
    def set_symbol(self, symbol: str):
        """Устанавливает текущий символ (потокобезопасно)"""
        with self._lock:
    ...
    def set_leverage(self, leverage: int):
        """Устанавливает плечо (потокобезопасно)"""
        with self._lock:
    ...
    def set_strategy(self, strategy: str):
        """Устанавливает стратегию (потокобезопасно)"""
        with self._lock:
    ...
    def set_mode(self, mode: str):
        """Устанавливает режим работы (потокобезопасно)"""
        with self._lock:
